        ...
        <main className="border-x-2 border-b-2 border-black p-6">
          ...
          <div className="space-y-6 pt-6">
            ...
            <p>
              ...
              （以下「当サービス」といいます）の利用条件を定めるものです。当サービスを利用するすべてのユーザー（以下「ユーザー」といいます）は、本規約に同意したものとみなします。
            </p>
            <section>
              <h2 className="text-xl font-bold mb-2">第1条（サービス内容）</h2>
              <p>
                当サービスは、パンダに関連する外部の技術ブログ、ニュース記事、動画等のコンテンツ（以下「外部コンテンツ」といいます）を自動的に収集し、ユーザーが閲覧しやすい形式で提供するニュースアグリゲーションサービスです。また、ユーザーによるコメント、いいね、ブックマーク機能を提供します。
              </p>
            </section>
            <section>
              <h2 className="text-xl font-bold mb-2">第2条（知的財産権）</h2>
              <p>
                当サービスを構成するテキスト、画像、デザイン、プログラムなどの著作権は、当サービスまたは正当な権利を有する第三者に帰属します。また、当サービスに表示される外部コンテンツの著作権およびその他の知的財産権は、各コンテンツの提供元または正当な権利者に帰属します。ユーザーが投稿したコメントの著作権は、投稿したユーザー本人に帰属します。
              </p>
            </section>
            <section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  ユーザーが投稿したコメント内容について、当サービスは一切の責任を負いません。
                </li>
                <li>
