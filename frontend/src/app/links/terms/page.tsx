      ...
      <div className="w-full max-w-xl">
        ...
        <main className="border-x-2 border-b-2 border-black p-6">
          <div className="space-y-6 pt-6">
            <p className="text-sm text-right">施行日: 2025年11月10日</p>
            <p>
            ...
            <section>
              ...
              <p>
                1.
                ユーザーが当サービスに投稿したコメント（以下「投稿コンテンツ」といいます）の著作権は、当該投稿を行ったユーザー本人に帰属します。
              </p>
              <p>
                2.
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                ...
                {/* ▼▼▼ ここから追記 ▼▼▼ */}
                <li>
                  当サービスは「現状有姿」で提供され、商品性、特定目的への適合性、非侵害性など、明示または黙示のいかなる保証も行いません。
                </li>
                <li>
                  ユーザーが投稿したコメント、いいね、ブックマークなどのデータが、システム障害、サービス終了、その他の理由によって失われた場合でも、当サービスはデータ損失に関する一切の責任を負いません。
                </li>
                {/* ▲▲▲ 追記ここまで ▲▲▲ */}
              </ul>
            </section>
